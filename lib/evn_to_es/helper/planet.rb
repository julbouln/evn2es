module EvnToEs
  module Helper
    module Planet
      def convert_spob(nova, spob)
        shipyards = self.conv.get_shipyards
        outfitters = self.conv.get_outfitters

        self.generate_config :planet, spob.shared_name do
          attributes = []
          ...
          if spob.cust_pic_id > 127
            ...
            entry :landscape, self.conv.convert_pict(spob.spin.sprites_id + 8000, "land", "-resize 720x360\!")
          end
